...
void lcMainWindow::CreateActions()
{
	...
	/*** LPub3D modification 333: - rotate step ***/
...
void lcMainWindow::CreateMenus()
{
	...
	/*** LPub3D modification 354: - rotate step ***/
...
//	LC_PIECE_SHOW_LATER,
	...
	/*** LPub3D modification 499: - menu management ***/
	//menus
...
void lcMainWindow::CreateToolBars()
{
	...
	/*** LPub3D modification 612: - undo/redo on tools menu ***/
	...
	/*** LPub3D modification 621: - angle action on tools menu ***/
  	mToolsToolBar->addAction(AngleAction);    // Snap Rotations to Fixed Intervals menu item
	/*** LPub3D modification end ***/
	/*** LPub3D modification 624: - rotate step on tools menu ***/
	...
	/*** LPub3D modification 638: - angle action toolbar popup ***/
...
/*** LPub3D modification 766: - enable 3D actions ***/
...
/*** LPub3D modification 1555: - rotate step ***/
